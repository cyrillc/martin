...
public class AIControllerFacadeTest {
	...
	public void setUp() throws Exception {
		...
		request = new MRequest("request test");
		...
		getHistoryResult.add(new MHistoryItem(new MRequest("command1"), new MResponse("response1")));
		getHistoryResult.add(new MHistoryItem(new MRequest("command2"), new MResponse("response2")));
		getHistoryResult.add(new MHistoryItem(new MRequest("command3"), new MResponse("response3")));
