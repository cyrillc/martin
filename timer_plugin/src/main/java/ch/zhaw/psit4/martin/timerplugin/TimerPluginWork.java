...
public class TimerPluginWork extends Feature {

    public TimerPluginWork(long requestID) {
        super(requestID);
    }
    ...
    private void testOutputQueue() {
        ...
        TimerPlugin.context.addToOutputQueue(ret1);
        TimerPlugin.context.addToOutputQueue(ret2);
        TimerPlugin.context.addToOutputQueue(ret3);
    }
